...
public class Townhouse extends AppCompatActivity {
    private CheckBox townhouse1checkbox,townhouse2checkbox;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_townhouse);
        townhouse1checkbox=findViewById(R.id.checkBox9);
        townhouse2checkbox=findViewById(R.id.checkBox10);
    }
    public void save_checked(View view){//saving information from checkboxes to further process on checkout page
        ...
        boolean townhouse1state = townhouse1checkbox.isChecked();
        boolean townhouse2state = townhouse2checkbox.isChecked();
